...
// Note: Comprehensive Array/Dictionary/Variant tests are in the GDScript integration tests
// (demo/test/*_integration.gd). Those tests are better suited for runtime-dependent types
// because they can use the full LuaState API from GDScript without needing to expose
